...
#
# kv260_platform.tcl: Tcl script for re-creating project 'kv260_platform'
#
# Generated by Vivado on Tue Apr 16 10:44:42 EDT 2024
...
#
# 1. This project restoration tcl script (kv260_platform.tcl) that was generated.
#
...
#
#    "/home/david/prj/my_repos/kv260_platform/hw/bd/kv260_platform_bd/hdl/kv260_platform_bd_wrapper.vhd"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../bd/kv260_platform_bd/hdl/kv260_platform_bd_wrapper.vhd"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "kv260_platform"
...
set script_file "kv260_platform.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/kv260_platform"]"
...
set_property -name "platform.description" -value "This platform provides high PS DDR bandwidth and three clocks: 100MHz, 200MHz and 400MHz" -objects $obj
...
set_property -name "platform.name" -value "kv260_platform" -objects $obj
set_property -name "platform.version" -value "0.1" -objects $obj
...
set file "$origin_dir/../bd/kv260_platform_bd/hdl/kv260_platform_bd_wrapper.vhd"
...
set_property -name "top" -value "kv260_platform_bd_wrapper" -objects $obj
...
# Proc to create BD kv260_platform_bd
proc cr_bd_kv260_platform_bd { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name kv260_platform_bd
...
\
  ...
  # Create instance: reset_400m, and set properties
  set reset_400m [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 reset_400m ]
  ...
  connect_bd_net -net clk_wiz_0_clk_100m [get_bd_pins clk_wiz_0/clk_100m] [get_bd_pins reset_100m/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_200m [get_bd_pins clk_wiz_0/clk_200m] [get_bd_pins reset_200m/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK]
  connect_bd_net -net clk_wiz_0_clk_400m [get_bd_pins clk_wiz_0/clk_400m] [get_bd_pins reset_400m/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins reset_200m/dcm_locked] [get_bd_pins reset_100m/dcm_locked] [get_bd_pins reset_400m/dcm_locked]
  connect_bd_net -net reset_200m_peripheral_aresetn [get_bd_pins reset_200m/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins reset_100m/ext_reset_in] [get_bd_pins reset_200m/ext_reset_in] [get_bd_pins reset_400m/ext_reset_in]
  ...
  set_property PFM_NAME {xilinx:kv260:kv260_platform:0.1} [get_files [current_bd_design].bd]
  ...
  set_property PFM.CLOCK {clk_100m {id "0" is_default "false" proc_sys_reset "/reset_100m" status "fixed" freq_hz "100000000"} clk_200m {id "1" is_default "true" proc_sys_reset "/reset_200m" status "fixed" freq_hz "200000000"} clk_400m {id "2" is_default "false" proc_sys_reset "/reset_400m" status "fixed" freq_hz "400000000"}} [get_bd_cells /clk_wiz_0]
...
# End of cr_bd_kv260_platform_bd()

cr_bd_kv260_platform_bd ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files kv260_platform_bd.bd ] 
set_property PFM_NAME "xilinx:kv260:kv260_platform:0.1" [get_files kv260_platform_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files kv260_platform_bd.bd ] 
